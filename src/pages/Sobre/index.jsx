  ...
  return (
    <div className="container top" id='sobre_link'> {/* id apenas para página única /> */}
      ...
      <div className='sobre_box'>
        <p>
          Faz 2 anos e 5 meses que estudo para ser um Desenvolvedor, estudo todos os dias, porém ainda não consegui um trabalho na área. Meu ponto forte é Front-end, mas tenho noções de Back-end, quero ser um Full-Stack.
